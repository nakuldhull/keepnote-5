...
public class ReminderController {
	...
	public ResponseEntity<?> update(@RequestBody Reminder reminder, @PathVariable String id) {
		try {
			return new ResponseEntity<Reminder>(reminderService.updateReminder(reminder, id), HttpStatus.OK);
		} catch (ReminderNotFoundException e) {
			return new ResponseEntity<String>("Not Found", HttpStatus.NOT_FOUND);
		}		
	}
	...
	public ResponseEntity<?> getById(@PathVariable String id) {
		try {
			return new ResponseEntity<Reminder>(reminderService.getReminderById(id), HttpStatus.OK);
		} catch (ReminderNotFoundException e) {
